...
<!-- A continuacion se agrega codigo de Java al documento mediante un lenguaje de marcas llamado scrptlet -->

<% // Comentario de una sola linea
	/*Comentario que puede abarcar varias lines */
...
List<String> nombres = List.of("Elida", "Jackelin", "Yodalis", "Miguel", "Gina", "Youssef");
